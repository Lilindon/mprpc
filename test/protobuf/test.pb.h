...
class LoginResponce;
struct LoginResponceDefaultTypeInternal;
...
class LoginResponce final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LoginResponce) */ {
 public:
  inline LoginResponce() : LoginResponce(nullptr) {}
  ~LoginResponce() override;
  explicit constexpr LoginResponce(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(LoginResponce* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit LoginResponce(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
// int32 errcode = 1;
inline void LoginResponce::clear_errcode() {
  errcode_ = 0;
}
inline int32_t LoginResponce::_internal_errcode() const {
  return errcode_;
}
inline int32_t LoginResponce::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponce.errcode)
  return _internal_errcode();
}
inline void LoginResponce::_internal_set_errcode(int32_t value) {
  
  errcode_ = value;
}
inline void LoginResponce::set_errcode(int32_t value) {
  _internal_set_errcode(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponce.errcode)
}

// string errmsg = 2;
inline void LoginResponce::clear_errmsg() {
  errmsg_.ClearToEmpty();
}
inline const std::string& LoginResponce::errmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponce.errmsg)
  return _internal_errmsg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginResponce::set_errmsg(ArgT0&& arg0, ArgT... args) {
 
 errmsg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginResponce.errmsg)
}
inline std::string* LoginResponce::mutable_errmsg() {
  std::string* _s = _internal_mutable_errmsg();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponce.errmsg)
  return _s;
}
inline const std::string& LoginResponce::_internal_errmsg() const {
  return errmsg_.Get();
}
inline void LoginResponce::_internal_set_errmsg(const std::string& value) {
  
  errmsg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LoginResponce::_internal_mutable_errmsg() {
  
  return errmsg_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* LoginResponce::release_errmsg() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponce.errmsg)
  return errmsg_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void LoginResponce::set_allocated_errmsg(std::string* errmsg) {
  if (errmsg != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponce.errmsg)
}

// bool success = 3;
inline void LoginResponce::clear_success() {
  success_ = false;
}
inline bool LoginResponce::_internal_success() const {
  return success_;
}
inline bool LoginResponce::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponce.success)
  return _internal_success();
}
inline void LoginResponce::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void LoginResponce::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponce.success)
}
